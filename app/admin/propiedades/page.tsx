            ...
            <Card key={propiedad.id} className="hover:shadow-md transition-shadow h-full flex flex-col">
              <CardContent className="p-0 flex flex-col flex-1">
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <div className="pt-3 border-t border-costa-beige mt-auto space-y-3">
                    {/* Fila 1: Toggle y Contacto */}
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <div className={`relative w-10 h-5 rounded-full transition-colors ${propiedad.publicada !== false ? 'bg-costa-olivo' : 'bg-gray-300'}`}>
                          <div className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform ${propiedad.publicada !== false ? 'translate-x-5' : 'translate-x-0.5'}`} />
                        </div>
                        <span className={`text-xs font-medium ${propiedad.publicada !== false ? 'text-costa-olivo' : 'text-gray-400'}`}>
                      ...
                      <a
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-costa-olivo hover:bg-costa-olivo/90 text-white text-xs font-medium transition-colors"
                      >
                    ...
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <Button variant="ghost" size="sm" onClick={() => handleDelete(propiedad.id)} title="Eliminar">
                        <Trash2 size={16} className="text-costa-coral" />
                      </Button>
                    </div>
                  </div>
                </div>
